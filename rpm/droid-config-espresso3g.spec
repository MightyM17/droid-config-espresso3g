...
%define device_pretty Galaxy Tab2
...
%include patterns/patterns-sailfish-device-adaptation-espresso3g.inc
%include patterns/patterns-sailfish-device-configuration-espresso3g.inc
