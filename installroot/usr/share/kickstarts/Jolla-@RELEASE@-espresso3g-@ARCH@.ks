# DisplayName: Jolla espresso3g/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: espresso3g
# DeviceVariant: espresso3g
# Brand: Jolla
...
repo --name=adaptation-community-common-espresso3g-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration espresso3g
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/espresso3g
